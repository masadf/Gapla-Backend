...
@Service
public final class LessonSpec {
    public static Specification<LessonEntity> fetchSome() {
    ...
    public static Specification<LessonEntity> courseIdEqual(Long expression) {

        return (root, query, builder) -> {
            return builder.equal(root.join("course").get("courseId"), expression);
        };
    }
